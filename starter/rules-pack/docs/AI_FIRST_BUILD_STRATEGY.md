...
**Build discipline (from zero-runtime games research)**
- Enforce 200–300 line max per Godot script to keep codebase AI-manageable. See `docs/RESEARCH_ZERO_RUNTIME_GAMES_2026.md`.
